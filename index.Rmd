...
Como se podrá apreciar en los capítulos que componen esta compilación, los participantes lograron alcanzar los aprendizajes esperados. Sin embargo, sí debo manifestar como aprendizaje propio que debió hacerse mayor hincapié en el desarrollo de habilidades de limpieza y ordenamiento de datos.

Las presentaciones y ejercicios resueltos de las sesiones se encuentran en [mi perfil de Rpubs.com](https://rpubs.com/scalderon). También es posible acceder al [repositorio en Github]() de este libro digital.
